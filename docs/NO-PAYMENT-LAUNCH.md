...
- Finalize the operator identity, launch regions/adult eligibility, support contact, retention/deletion rules and current terms/privacy version. Keep draft policies clearly labeled until this is complete. Existing acceptance is never rewritten to the new version.
