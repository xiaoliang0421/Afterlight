/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: da31e1c1ae2caa6689f67fcd73a6c6d4)
...
interface __BaseEnv_Env {
	...
	PROVIDER_MODE: "disabled" | "fixture";
	PUBLIC_ORIGIN: "https://afterlight-staging.liushenliang1994.workers.dev" | "https://configure-production.example" | "http://127.0.0.1:5178";
	TURNSTILE_SITE_KEY?: "0x4AAAAAAEqTHX9P9ZiVO_fR";
	ALLOW_DEV_LOGIN: "false" | "true";
	...
	STREAM_ACCOUNT_ID: "";
	SUPPORT_EMAIL: "talerelay@proton.me";
	STORY_ROOMS: DurableObjectNamespace<import("./worker/index").StoryRoom>;
	GENERATION: Workflow<Parameters<import("./worker/index").GenerationWorkflow['run']>[0]['payload']>;
	ARCHIVES: Workflow<Parameters<import("./worker/index").ArchiveWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "StoryRoom";
	}
	interface StagingEnv {
		...
		PUBLIC_ORIGIN: "https://afterlight-staging.liushenliang1994.workers.dev";
		TURNSTILE_SITE_KEY: "0x4AAAAAAEqTHX9P9ZiVO_fR";
	...
	interface ProductionEnv {
		...
		PROVIDER_MODE: "disabled";
		PUBLIC_ORIGIN: "https://configure-production.example";
		ALLOW_DEV_LOGIN: "false";
		PAYMENTS_ENABLED: "false";
		DIRECTOR_API_URL: "https://api.deepseek.com/chat/completions";
		DIRECTOR_MODEL: "deepseek-v4-flash";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "PROVIDER_MODE" | "PUBLIC_ORIGIN" | "TURNSTILE_SITE_KEY" | "ALLOW_DEV_LOGIN" | "PAYMENTS_ENABLED" | "DIRECTOR_API_URL" | "DIRECTOR_MODEL" | "FAL_MODEL" | "STREAM_ACCOUNT_ID" | "SUPPORT_EMAIL">> {}
}
